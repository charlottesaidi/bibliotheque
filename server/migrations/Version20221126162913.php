 ...
 */
final class Version20221126162913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, extension VARCHAR(255) NOT NULL, size DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE show_episode (id INT AUTO_INCREMENT NOT NULL, file_id INT NOT NULL, show_id INT NOT NULL, title VARCHAR(255) NOT NULL, number INT NOT NULL, season INT NOT NULL, release_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BAF8313993CB796C (file_id), INDEX IDX_BAF83139D0C1FC64 (show_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A33193CB796C FOREIGN KEY (file_id) REFERENCES file (id)');
        ...
        $this->addSql('ALTER TABLE show_episode ADD CONSTRAINT FK_BAF8313993CB796C FOREIGN KEY (file_id) REFERENCES file (id)');
        $this->addSql('ALTER TABLE show_episode ADD CONSTRAINT FK_BAF83139D0C1FC64 FOREIGN KEY (show_id) REFERENCES `show` (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE show_episode DROP FOREIGN KEY FK_BAF8313993CB796C');
        $this->addSql('ALTER TABLE show_episode DROP FOREIGN KEY FK_BAF83139D0C1FC64');
        ...
        $this->addSql('DROP TABLE show_episode');
    }
}
